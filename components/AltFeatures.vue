    ...
    <div class="relative">
      <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
        <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
          <div>
            <div>
              <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-orange-600">
            ...
            <div class="mt-6">
              <h2 class="text-3xl font-bold tracking-tight text-gray-900">
                Learn the biggest games in the casino industry, at your own pace
              </h2>
              ...
              <div class="mt-6">
                <a
                  href="#"
                  class="inline-flex rounded-lg bg-orange-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-orange-600 hover:bg-orange-700 hover:ring-orange-700"
                >Get
                  started</a>
              </div>
            </div>
            ...
            <blockquote>
              <div>
                <p class="text-base text-gray-500">
                  &ldquo;After 3 short months at Coast Dealing Academy, my skills got
                  me a well-paying job at <span class="text-gray-700">Scarlet Pearl</span> casino. I strongly recommend them.&rdquo;
                </p>
              </div>
              <footer class="mt-3">
      ...
      <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
        <div class="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
          <div>
            ...
            <div class="mt-6">
              <h2 class="text-3xl font-bold tracking-tight text-gray-900">
                Job guarantees at Mississippi's largest casinos
              </h2>
              <p class="mt-4 text-lg text-gray-500">
                Semper curabitur ullamcorper posuere nunc sed. Ornare iaculis bibendum
                malesuada faucibus lacinia porttitor. Pulvinar laoreet sagittis viverra duis. In venenatis sem arcu
