<template>
  ...
  -->
    <div v-if="isOpen" v-click-outside="vcoConfig" class="absolute z-20 w-screen max-w-md px-2 mt-3 transform -translate-x-1/2 left-1/2 sm:px-0">
      <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
        ...
        <div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
          ...
          <div class="mt-5 text-sm">
            <a href="#" class="font-medium transition duration-150 ease-in-out text-rose-600 hover:text-rose-500"> View all posts <span aria-hidden="true">&rarr;</span></a>
          </div>
        </div>
      </div>
    </div>
