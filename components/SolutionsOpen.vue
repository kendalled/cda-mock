<template>
  ...
  -->
    <div v-if="isOpen" v-click-outside="vcoConfig" class="absolute z-40 rounded-lg shadow-lg -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
