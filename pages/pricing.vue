  ...
  <div class="bg-white">
        ...
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <img class="h-8 w-auto sm:h-16 sm:absolute sm:top-3" src="~/static/cda-logo.png" alt="">
            </a>
          </div>
          ...
          <nav class="hidden space-x-10 md:flex">
            <div class="relative">
              ...
              <button
                type="button"
                class="text-gray-500 group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2"
                aria-expanded="false"
              >
                <span>Courses</span>
                <!--
                ...
                <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                      ...
                      <svg
                        class="h-6 w-6 flex-shrink-0 text-rose-600"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke-width="1.5"
            ...
            <div class="relative">
              ...
              <!--
                ...
                Leaving: "transition ease-in duration-150"
                  ...
                  To: "opacity-0 translate-y-1"
              -->
              <div v-if="false" class="absolute left-1/2 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
          ...
          <div class="hidden items-center justify-end space-x-8 md:flex md:flex-1 lg:w-0">
            ...
            <a
              href="#"
              class="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-rose-100 py-2 px-4 text-base font-medium text-rose-700 hover:bg-rose-200"
            >Sign
              up</a>
          </div>
        </div>
        ...
        <div class="pb-16 xl:flex xl:items-center xl:justify-between">
          <div>
            <h1 class="text-4xl font-bold tracking-tight sm:text-5xl">
              ...
              <span class="text-rose-600">$299 a month</span>
            </h1>
            <p class="mt-5 text-xl text-gray-500">
              Includes every game we offer plus a state-certified gaming license. Contact us for payment plans.
            </p>
          </div>
          <a
            href="#"
            class="mt-8 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-rose-600 py-3 px-5 text-base font-medium text-white hover:bg-rose-700 sm:mt-10 sm:w-auto xl:mt-0"
          >Get
            started today</a>
        </div>
        <div class="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
          <div>
            ...
            <p class="mt-4 text-lg text-gray-500">
              ...
              Malesuada adipiscing sagittis vel nulla nec. Urna, sed a lectus elementum blandit et.
            </p>
          </div>
    ...
    <div class="bg-rose-900">
      <div class="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 border-t border-rose-400 border-opacity-25 pt-10">
          <dl class="space-y-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 md:space-y-0">
            <div>
              ...
              <dd class="mt-2 text-base text-rose-200">
    ...
    <div class="bg-rose-50">
      <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-24 lg:px-8">
        <h2 class="text-3xl font-bold tracking-tight text-rose-900 sm:text-4xl">
          ...
          <span class="block text-rose-600">Start your free trial today.</span>
        </h2>
        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
          <div class="inline-flex rounded-md shadow">
            <a
              href="#"
              class="inline-flex items-center justify-center rounded-md border border-transparent bg-rose-600 py-3 px-5 text-base font-medium text-white hover:bg-rose-700"
            >Get
              started</a>
          </div>
        </div>
